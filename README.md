...
[Finetuning on JDDC (Response Generation)](examples/knowledge_pretrain/README.finetune.jddc.md)

[Finetuning on ECD Corpus (Response Retrieval)](examples/knowledge_pretrain/README.finetune.ecd.md)

[Finetuning on JD Product Dataset (Abstractive Summarization)](examples/knowledge_pretrain/README.finetune.summarization.cate.md)

[Finetuning on MEPAVE Dataset (Sequence Tagging)](examples/knowledge_pretrain/README.finetune.seq_tagging.md)

...
class MASSDecoder(TransformerDecoder):
    def forward(
        ...
        positions=None  # additional args
    ):
        x, extra = self.extract_features(
            ...
            positions=positions  # additional args
        )
    ...
    def extract_features(
        ...
        if positions is not None:
            positions = super(LearnedPositionalEmbedding, self.embed_positions).forward(positions)
        else:
...
class TransformerMASSModel(TransformerModel):
    ...
    def forward(self, src_tokens=None, src_lengths=None, prev_output_tokens=None, positions=None, masked_tokens=None):
        """
        """
        encoder_out = self.encoder(src_tokens, src_lengths=src_lengths)
        x, extra = self.decoder(prev_output_tokens, encoder_out=encoder_out, positions=positions)

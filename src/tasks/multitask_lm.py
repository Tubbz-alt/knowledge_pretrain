...
from .mass_lm import MaskedS2STask
from ..data.rstrip_token_dataset import RStripTokenDataset
from ..data.knowledge_language_pair_dataset import KnowledgeLanguagePairDataset
...
class MultitaskLMTask(MaskedS2STask):
    ...
    def build_model(self, args):
        ...
        if args.tagging_head_name:
            num_class = self.args.tag_num_classes if self.args.tag_num_classes > 0 else self.args.num_classes
